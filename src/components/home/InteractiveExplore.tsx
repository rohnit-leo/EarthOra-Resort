...
export function InteractiveExplore() {
  ...
  const cards = [
    ...
    { title: "Cottages Sideview & Lawns", desc: "Picturesque side views of our cottage row bordering open lawns.", img: "https://3t11ypwbknpvqnak.public.blob.vercel-storage.com/resort/IMG_3066.PNG" },
